...
export PS1='$(__git_ps1 "\[\e[37m\](\[\e[0m\]")$(__git_dirty "\[\e[31m\]✗\[\e[0m\]")$(__git_clean "\[\e[32m\]✓\[\e[0m\]")$(__git_ps1 " \[\e[34m\]%s\[\e[0;37m\])\[\e[0m\] ")$(__jobs_any "\[\e[33m\]ꕚ \[\e[0m\]")\[\e[36m\]\w\[\e[0;33m\]\$\[\e[0m\] '
